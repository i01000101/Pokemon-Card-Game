...
public class Jigglypuff extends pokemon {
	...
	public Jigglypuff(String pokemon_name,int pokemon_id,String pokemon_kind) 
	{
		super(pokemon_name,pokemon_id,pokemon_kind);
		
		try {
			setter_cart_image(ImageIO.read(new File("Jigglypuff.png")));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			System.err.println("Jigglypuff resmi yok !");
		}
	}
