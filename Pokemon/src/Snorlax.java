...
public class Snorlax extends pokemon {
	...
	public Snorlax(String pokemon_name,int pokemon_id,String pokemon_kind) 
	{
		super(pokemon_name,pokemon_id,pokemon_kind);
		
		try {
			setter_cart_image(ImageIO.read(new File("Snorlax.png")));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			System.err.println("Snorlax resmi yok !");
		}
	}
